...
public interface FarmDuomobItemConverter {

    FarmDuomobItemConverter INSTANCE = Mappers.getMapper(FarmDuomobItemConverter.class);

    FarmDuomobItem dtoToEntity(FarmDuomobItemDTO farmDuomobItemDTO);
    ...
    FarmDuomobItem formToEntity(FarmDuomobForm form);
}
