package com.muling.gateway.security;

import cn.hutool.core.codec.Base64;
import cn.hutool.core.io.IoUtil;
import com.muling.common.constant.SecurityConstants;
import com.muling.common.result.ResultCode;
import com.muling.gateway.security.config.SecurityProperties;
...
public class ResourceServerConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        ...
        http.authorizeExchange()
                .pathMatchers(securityProperties.getIgnoreUrls()).permitAll()
