package com.muling.gateway.captcha.handler;

import cn.hutool.core.util.IdUtil;
import com.muling.common.constant.SecurityConstants;
import com.muling.common.result.Result;
import com.muling.gateway.captcha.producer.CaptchaProducer;
import com.muling.gateway.captcha.enums.CaptchaTypeEnum;
...
public class CaptchaHandler implements HandlerFunction<ServerResponse> {
    ...
    public Mono<ServerResponse> handle(ServerRequest request) {
        ...
        stringRedisTemplate.opsForValue().set(SecurityConstants.VALIDATE_CODE_PREFIX + uuid, captchaValue, captchaValueTtl, TimeUnit.SECONDS);
