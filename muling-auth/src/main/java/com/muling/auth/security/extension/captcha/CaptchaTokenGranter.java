package com.muling.auth.security.extension.captcha;
...
public class CaptchaTokenGranter extends AbstractTokenGranter {
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        Assert.isTrue(StrUtil.isNotBlank(validateCode), "verify code cannot be null");
        ...
        Assert.isTrue(StrUtil.isNotBlank(correctValidateCode),"验证码无效");
