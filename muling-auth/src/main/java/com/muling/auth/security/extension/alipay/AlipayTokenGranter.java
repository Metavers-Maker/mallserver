 ...
 * @date 2022/9/25
 */
public class AlipayTokenGranter extends AbstractTokenGranter {

    /**
     * 声明授权者 CaptchaTokenGranter 支持授权模式 alipay
     * 根据接口传值 grant_type = alipay 的值匹配到此授权者
     * 匹配逻辑详见下面的两个方法
     *
    ...
    public AlipayTokenGranter(AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService, OAuth2RequestFactory requestFactory, AuthenticationManager authenticationManager) {
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        Authentication userAuth = new AlipayAuthenticationToken(code, encryptedData,iv); // 未认证状态
