package com.muling.auth.security.extension.refresh;

import com.muling.auth.security.config.AuthorizationServerConfig;
...
//        AuthenticationMethodEnum authenticationMethodEnum = AuthenticationMethodEnum.getByValue(RequestUtils.getAuthenticationMethod());
        AuthenticationMethodEnum authenticationMethodEnum = IBaseEnum.getEnumByValue(RequestUtils.getAuthenticationMethod(), AuthenticationMethodEnum.class);
