...
import com.muling.mall.oms.pojo.dto.ApplePayRefundIosDTO;
 ...
 * 苹果回调接口
 */
@Api(tags = "app-苹果支付回调接口")
@Slf4j
@Validated
@RestController
@RequiredArgsConstructor
@RequestMapping("/callback-api/v1/apple-pay")
public class ApplePayCallbackController {
    ...
    public String applePayOrderNotify(@RequestBody ApplePayCallBackDTO callBackDTO) {
    ...
    @PostMapping("/refund")
    public void refund(@RequestBody ApplePayRefundIosDTO refundIosDTO) {
