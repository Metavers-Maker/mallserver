package com.muling.common.swagger.config;
 ...
 * <p>
 * 表示在开发或测试环境开启，而在生产关闭。（推荐使用） 禁用方法2：使用注解@ConditionalOnProperty(name = "swagger.enabled",
 * <p>
 * havingValue = "true") 然后在测试配置或者开发配置中添加swagger.enabled=true即可开启，生产环境不填则默认关闭Swagger.
 * </p>
 */
