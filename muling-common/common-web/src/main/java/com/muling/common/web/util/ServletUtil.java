...
import com.muling.common.util.JSONUtil;
...
public class ServletUtil extends jodd.servlet.ServletUtil {
    ...
    public static String getConnectorRid(ServletRequest request) {

        return getHeader(request, RID_HEADER);
    }

    public static String getConnectorRid() {

        return getHeader(getCurrentRequest(), RID_HEADER);
    }

    public static String getUserAgent(ServletRequest request) {

        return getHeader(request, USER_AGENT_HEADER);
    }

    public static String getUserAgent() {

        return getHeader(getCurrentRequest(), USER_AGENT_HEADER);
    }
}
