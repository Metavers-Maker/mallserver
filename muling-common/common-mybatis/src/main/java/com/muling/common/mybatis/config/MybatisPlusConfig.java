package com.muling.common.mybatis.config;
...
import com.muling.common.mybatis.handler.*;
...
public class MybatisPlusConfig {
    ...
    public ConfigurationCustomizer configurationCustomizer() {
        return configuration -> {
            ...
            typeHandlerRegistry.register(JSONObject.class, JdbcType.OTHER, JsonObjectSqlJsonHandler.class);
        };
    }
