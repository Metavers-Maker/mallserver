...
import com.muling.common.web.encrypt.base.ReqSecret;
import com.muling.common.web.encrypt.base.SecretHttpMessage;
...
public class SecretRequestAdvice extends RequestBodyAdviceAdapter {
    ...
    private String decryptBody(HttpInputMessage inputMessage) throws IOException {
        ...
        if (CollectionUtils.isEmpty(headers.get("clientType"))
            ...
            throw new BizException(ResultCode.ERROR, "请求解密参数错误，clientType、timestamp、salt、signature等参数传递是否正确传递");
        }
        ...
        ReqSecret reqSecret = JSONUtil.toBean(requestBody, ReqSecret.class);
        ...
        if (!newSignature.equals(signature)) {
            // 验签失败
            throw new BizException(ResultCode.ERROR, "验签失败，请确认加密方式是否正确");
        }
        ...
        throw new BizException(ResultCode.ERROR, "解密失败");
    }
}
